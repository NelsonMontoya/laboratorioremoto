export const preguntas =[
    ...
    {
        pregunta: `¿Qué componente se utiliza típicamente en un circuito de control por fase para
        regular el ángulo de conducción y, por lo tanto, la potencia entregada a una carga
        en un sistema de electrónica de potencia?`,
    ...
    },
    {
        ...
        inductivas?`,
        opcionUno: `Porque las cargas inductivas pueden generar picos de corriente que pueden
        dañar el circuito de control por fase`,
        opcionDos: `Porque las cargas inductivas causan distorsión en la forma de onda de
        corriente y voltaje, lo que afecta el funcionamiento del circuito de control por fase`,
    ...
    },
    {
        ...
        opcionUno: `El ángulo en el cual se produce el apagado de los dispositivos de control por
        fase.`,
        opcionDos: `El ángulo en el que se produce el encendido de los dispositivos de control por
        fase.`,
    ...
    },
    {
        pregunta: `¿Cuál es una diferencia clave entre un SCR (Rectificador Controlado de
            Silicio) y un TRIAC?`,
        opcionUno: `El SCR es un dispositivo bidireccional, mientras que el TRIAC es unidireccional.`,
        opcionDos: `El SCR puede controlar la corriente en un solo sentido, mientras que el TRIAC
